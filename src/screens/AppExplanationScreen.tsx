  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        />
        <ExplanationCard
          title="طبعة المصحف (قريباً طبعات أكثر)"
          icon="layers-outline"
          color={Colors.gold}
          content="يمكنك حالياً القراءة من &quot;مصحف المدينة المنورة&quot; عالي الجودة، وقريباً جداً سنوفر طبعات إضافية (الشمرلي، باكستاني، إلخ) لتناسب تفضيلاتك في الحفظ، مع دعم استراتيجيات مراجعة متقدمة."
        />
        <ExplanationCard
